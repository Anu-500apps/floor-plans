                        ...
                        <div class="mt-2 mb-2 ml-[15.25rem] flex">
                          ...
                          <div>
                            ...
                            <button
                              ...
                              @click="submitBankForm(), (open = false)"
                            >
                              Submit
                            </button>
                          </div>
...
// Define Emits
const emits = defineEmits(["submit-bank-data"]);
const formData = ref({
    category: "",
    skill: "",
    question_type: "text",
...
const submitBankForm = () => {
   emits("submit-bank-data", formData.value);
};
</script>